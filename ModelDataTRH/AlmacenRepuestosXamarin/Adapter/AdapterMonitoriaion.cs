    ...
    public class AdapterMonitoriaion : BaseAdapter<vListadoPedidosMonitorizacion>
    {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (view == null)
                ...
                view.FindViewById<TextView>(Resource.Id.Fecha).Text = item.Fecha_Carga_Requerida.HasValue ? item.Fecha_Carga_Requerida.Value.ToLocalTime().ToString("d") : string.Empty;
