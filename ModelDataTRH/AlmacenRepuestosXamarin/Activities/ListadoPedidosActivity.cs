...
{
    [Activity(Label = "ListadoPedidosActivity")]
    public class ListadoPedidosActivity : BaseActivity
    {
        private ListView listPedidos;
        public static string comercial = "V001";
        private AdapterListadoPedidos adapter { get; set; }
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            listPedidos = FindViewById<ListView>(Resource.Id.listViewNuevaOfertaFragment);

            listPedidos.Adapter = getAdapterListadoPedidos(comercial);
            listPedidos.ItemClick += OnListItemClick;
            sve = new SearchViewExpandListener(adapter);
            SupportActionBar.Title = "Listado de Pedidos";
        ...
        void OnListItemClick(object sender, AdapterView.ItemClickEventArgs e)
        {
            ...
            Pedido c = adapter.list[e.Position];
        ...
        public IListAdapter getAdapterListadoPedidos(string comercial)
        {
            List<Pedido> l = AccesoDatos.listaPedidos.Where(p => p.salesperson_CodeField == comercial).ToList();

            adapter = new AdapterListadoPedidos(this, l);
            return adapter;
        }
