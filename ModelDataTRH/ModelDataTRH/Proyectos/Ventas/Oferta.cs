...
namespace ModelDataTRH.Ventas
{
    public class Oferta
    {
        ...
        public double coste_Total_TransporteField { get; set; }
        public bool coste_Total_TransporteFieldSpecified { get; set; }
        public double euros_Tm_PorteField { get; set; }
        public bool euros_Tm_PorteFieldSpecified { get; set; }
        public int tipo_Gestion_TransporteField { get; set; }
        ...
        public SalesLinesField salesLinesField = new SalesLinesField();
        ...
        public class SalesLinesField
        {
            ...
            public string location_CodeField { get; set; }
            public double quantityField { get; set; }
            ...
            public double precio_Patio_M2Field { get; set; }
            public bool precio_Patio_M2FieldSpecified { get; set; }
            public double precio_Patio_TMField { get; set; }
            public bool precio_Patio_TMFieldSpecified { get; set; }
            public double precio_Patio_PanoField { get; set; }
            public bool precio_Patio_PanoFieldSpecified { get; set; }
            public double precioLineaTotalField { get; set; }
            public bool precioLineaTotalFieldSpecified { get; set; }
            public double precioLineaTotalPatioField { get; set; }
